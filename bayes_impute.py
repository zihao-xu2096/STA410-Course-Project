...
class BayesianImputer:
    ...
    def bayesian_regression_impute(self, target_col, n_iter=100):
        ...
        print(
            f"[Bayesian Regression] Imputed {missing_mask.sum()} values in '{target_col}' across {self.num_imputations} datasets")
    ...
    def causal_impute(self):
        ...
        raise NotImplementedError(
            "Causal inference support is not implemented. See docstring for suggested directions.")
